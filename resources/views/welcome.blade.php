...
<head>
        ...
        {{-- <link rel="stylesheet" href="https://unpkg.com/sliderjs@1.3.5/dist/sliderjs.min.css" /> --}}
        {{-- <script src="https://unpkg.com/sliderjs@1.3.5/dist/sliderjs.min.js"></script> --}}
        ...
        <style>
            * {
            ...
            to {
                text-shadow: 20px 0 70px #ebff33;
                color: #ebff33;
            }
            }
...
<body>
    ...
    <div class="nav-container wrapper">
        {{-- <button style="background: #ff0266; border:none; padding:10px;">View</button> --}}
            <p class="inner">
    ...
    <section id="tab-esbuild" class="slider">
        <h1>ESBUILD</h1>
        <h2>an extremely fast JavaScript bundler</h2>
    </section>
    <section id="tab-next" class="slider">
        <h1>NEXT.JS</h1>
        <h2>framework for Production</h2>
    </section>
    <section id="tab-typescript" class="slider">
        <h1>TYPESCRIPT</h1>
        <h2>giving you better tooling at any scale</h2>
    </section>
    <section id="tab-vite" class="slider">
        <h1>VITE</h1>
